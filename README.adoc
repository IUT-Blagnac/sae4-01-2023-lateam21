...
L'https://github.com/IUT-Blagnac/sae4-01-2023-lateam21/blob/master/Livrables/Livrable%20SAE%20.pdf[analyse du code source] existant de l’application liste les principales défauts constatés et les possibles tâches de refactoring à appliquer.

=== Cahier de Recette
Le https://github.com/IUT-Blagnac/sae4-01-2023-lateam21/blob/master/Livrables/Cahier_des_recettes.adoc[cahier de recette] de l’application atteste du bon fonctionnement de cette dernière en détaillant des plans de tests pour chaque fonctionnalité avec les actions à réaliser, les résultats attendus et ceux obtenus. Ce document explique également comment lancer l’application simplement avec Maven à partir de fichiers exécutables fournis avec le code source

=== Scripts d'éxecution de l'application
...
- Sous Windows, lancer le script https://github.com/IUT-Blagnac/sae4-01-2023-lateam21/blob/master/Belote2023/RunBelote2023.bat[RunBelote2023.bat]
- Sous Linux, lancer le script https://github.com/IUT-Blagnac/sae4-01-2023-lateam21/blob/master/Belote2023/RunBelote2023.sh[RunBelote2023.sh]

=== Compte rendu du refactoring de l'application

https://github.com/IUT-Blagnac/sae4-01-2023-lateam21/blob/master/Livrables/Compte%20rendu.adoc[Compte rendu du refactoing] est la documentation finale du projet, mettant en avance toutes les changemenets importants que on a fait, les ajout des classes, des methodes, des patterns, et de nos âmes.
